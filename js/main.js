...
window.onload = function () {
    ...
    const ZOOM_OUT = 1.1;
    const ZOOM_IN = 0.9;
    const canvas = new Canvas({ width: 650, height: 650, WINDOW, callbacks: { wheel, mouseup, mouseleave, mousedown, mousemove, move } });
    ...
    const SCENE = [
        ...
        sur.sphere(40, 8, new Point(0, 0, 0),'#FFFF00', { }),
        sur.sphere(40,1, new Point(0, -10, 0),'#FFE4B5', { rotateOz : new Point}),
        sur.sphere(40, 1, new Point(-13, 0, 0),'#FF8C00', { rotateOz : new Point}),
        sur.sphere(40,3, new Point(0, 21, 0),'#00BFFF', { rotateOz : new Point}),
        sur.sphere(40,2.5, new Point(30, 0, 0),'#FF4500', { rotateOz : new Point}),
        sur.sphere(40,4.7, new Point(0,-41 , 0),'#DEB887', { rotateOz : new Point}),
        sur.sphere(40, 4, new Point(-54, 0, 0),'#CD853F', { rotateOz : new Point}),
        sur.bublik(40, 8, new Point(-54, 0, 0),'#CD853F', { rotateOz : new Point} ),
        sur.sphere(40,3.3, new Point(0, 72, 0),'#AFEEEE', { rotateOz : new Point}),
        sur.sphere(40,3.3 , new Point(80, 0, 0),'#00FFFF', { rotateOz : new Point}),
    ];
    const LIGHT = [new Light(0, 0, 0, 100 ),
